class User < ApplicationRecord
    ...
    has_many :created_compositions, class_name: 'Composition', foreign_key: :creator
    has_many :created_user_compositions, class_name: 'UserComposition', foreign_key: :creator
    has_secure_password
